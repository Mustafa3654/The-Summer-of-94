...
public static class SetupSummerOf94
{
    ...
    /// <summary>
    /// Drops in the night sky rig. The moon quad, its texture, and the starfield are all
    /// generated by NightSkyController itself, so nothing untextured is serialised into the
    /// scene; only the skybox material and the moonlight reference are wired here.
    /// </summary>
